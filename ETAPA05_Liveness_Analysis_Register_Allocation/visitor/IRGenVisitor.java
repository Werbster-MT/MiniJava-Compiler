...
public class IRGenVisitor {
    ...
    private Map<String, frame.Frame> frames = new LinkedHashMap<>();

    public Map<String, frame.Frame> getFrames() {
        return frames;
    }
    ...
    private Tree.Stm transMainClass(MainClass m) {
        ...
        frames.put(mainLabelName(m), currentFrame);
        currentClass = null;
        currentMethod = null;
    ...
    public Tree.Stm transMethodDecl(MethodDecl m, String className) {
        ...
        frames.put(methodLabelName(className, m.i.s), currentFrame);
        return currentFrame.procEntryExit1(body);
    }
